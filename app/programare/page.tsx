...
export default function BookingPage() {
  ...
  return <main className="booking-page"><Link className="booking-back" href="/">← Înapoi la acasă</Link><div className="booking-card"><p className="section-kicker">Programare</p><h1>Programare {label} cu {specialist}</h1><p>Categoria și specialistul au fost deja selectate. Alege serviciul dorit pentru a continua.</p><div className="booking-selection"><span>Categorie</span><strong>{label}</strong><span>Specialist</span><strong>{specialist}</strong></div><button className="button button-primary booking-choice" type="button">Alege serviciul <span aria-hidden="true">↗</span></button></div></main>;
}
