...
export default function Home() {
  ...
  return (
    <main id="acasa" className={`site-shell${introVisible ? ' intro-active' : ''}`}>
      ...
      <section id="hero" className={`split-hero${heroReady ? ' hero-ready' : ''}`} aria-label="Alege serviciul dorit"><div className="split-panel split-panel-lashes"><a href="/programare?categorie=gene" aria-label="Programează-te pentru gene cu Dariana"><span className="split-index">01</span><div className="split-image-frame"><img className="split-panel-image" src="/assets/beauty/lashes-eye-cutout.png" alt="Ochi cu gene accentuate" /></div><div className="split-panel-content"><p className="split-kicker">Cu Dariana</p><h1>GENE</h1><p>Extensii, laminare și efecte personalizate.</p><span className="split-link">Programează-te pentru gene <b aria-hidden="true">↗</b></span></div><span className="split-detail split-detail-lashes" aria-hidden="true">⌁</span></a></div><div className="split-divider" aria-hidden="true" /><div className="split-panel split-panel-nails"><a href="/programare?categorie=unghii" aria-label="Programează-te pentru unghii cu Lucia"><span className="split-index">02</span><div className="split-image-frame"><img className="split-panel-image" src="/assets/beauty/nails-hand-cutout.png" alt="Mână cu unghii îngrijite" /></div><div className="split-panel-content"><p className="split-kicker">Cu Lucia</p><h1>UNGHII</h1><p>Manichiură, întreținere și design personalizat.</p><span className="split-link">Programează-te pentru unghii <b aria-hidden="true">↗</b></span></div><span className="split-detail split-detail-nails" aria-hidden="true">✦</span></a></div></section>
