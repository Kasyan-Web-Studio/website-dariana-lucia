export const aboutContent = {
  ...
  specialists: [
    { name: 'Dariana', role: 'Lash Artist', image: '/assets/about/dariana.jpeg', imageAlt: 'Dariana, specialistă în extensii de gene', description: 'Dariana este specializată în extensii de gene, laminare și efecte personalizate. Pune accent pe proporții armonioase, confort și rezultate adaptate fizionomiei fiecărei cliente.', serviceHref: '/servicii?categorie=gene', serviceLabel: 'Vezi serviciile pentru gene', bookingHref: '/programare?categorie=gene', bookingLabel: 'Programează-te cu Dariana' },
